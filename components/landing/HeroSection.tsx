...
export function HeroSection() {
    ...
    const itemVariants = {
        ...
        visible: { opacity: 1, y: 0, transition: { duration: 0.8, ease: "easeOut" as any } } // easeOutCubic approximation
    };
            ...
            <div className="container mx-auto px-6 relative z-10 flex flex-col items-center gap-12">
                ...
                >
                    <div className="relative transform scale-90 md:scale-100">
                        ...
                        <motion.div
                            animate={{ x: [0, -5, 0] }}
                            transition={{ duration: 5, repeat: Infinity, ease: "easeInOut" as any, delay: 1.5 }}
                        ...
                        <motion.div
                            animate={{ x: [0, 5, 0] }}
                            transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" as any, delay: 0.5 }}
